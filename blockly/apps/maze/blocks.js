...
Blockly.Language.maze_left = {
  // Block for moving forward.
  helpUrl: 'http://code.google.com/p/blockly/wiki/Move',
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
        .appendTitle("Step Left");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(MSG.moveForwardTooltip);
  }
...
Blockly.Language.maze_down = {
  // Block for moving forward.
  helpUrl: 'http://code.google.com/p/blockly/wiki/Move',
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
        .appendTitle("Step Down");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(MSG.moveForwardTooltip);
  }
...
Blockly.Language.maze_loop = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendTitle("repeat")
        .appendTitle(new Blockly.FieldDropdown([["1", "top1"], ["2", "top2"], ["3", "bottom1"], ["4", "bottom2"], ["5", "bag"]]), "part");
    this.appendStatementInput('DO').appendTitle(MSG.doCode);
    this.setPreviousStatement(true);
    this.setTooltip(MSG.whileTooltip);
  }
