...
Blockly.Block.prototype.showContextMenu_ = function(x, y) {
  ...
  Blockly.ContextMenu.show(x, y, options);
      ...
      toolbox1 += '<category name="+ الشعر"> <block type="hair1"></block> <block type="hair2"></block>';
      toolbox1 += '</category> <category> </category>'; //close hair
      
      toolbox1 += '<category name="+ الحذاء"> <block type="shoes1"></block> <block type="shoes2"></block>';
      ...
      toolbox3 += '<category name="+ الشعر"> <block type="hair1"></block> <block type="hair2"></block> <block type="hair3"></block> <block type="hair4"></block>';
      ...
      toolbox4 += '<category name="+ الشعر"> <block type="hair1"></block> <block type="hair2"></block> <block type="hair3"></block> <block type="hair4"></block> <block type="hair5"></block>';
      ...
      toolbox5 += '<category name="+ الشعر"> <block type="hair1"></block> <block type="hair2"></block> <block type="hair3"></block> <block type="hair4"></block> <block type="hair5"></block>';
      ...
      toolbox7 += '<category name="+ الشعر"> <block type="hair1"></block> <block type="hair2"></block> <block type="hair3"></block> <block type="hair4"></block> <block type="hair5"></block>';
      toolbox7 += '</category> <category> </category>'; //close hair
      
      toolbox7 += '<category name="+ الحذاء"> <block type="shoes1"></block> <block type="shoes2"></block> <block type="shoes3"></block> <block type="shoes4"></block> <block type="shoes5"></block>';
      ...
      switch(CURRENT_LEVEL)
      {
        ...
        case 2:
          ...
          break;
        case 3:
          Blockly.inject(document.getElementById('rosie-code'), {path: '../blockly/', toolbox: toolbox3, rtl: true } );
          break;
        case 4:
          Blockly.inject(document.getElementById('rosie-code'), {path: '../blockly/', toolbox: toolbox4, rtl: true } );
          break; 
        case 5:
          Blockly.inject(document.getElementById('rosie-code'), {path: '../blockly/', toolbox: toolbox5, rtl: true } );
          break;
        case 6:
          Blockly.inject(document.getElementById('rosie-code'), {path: '../blockly/', toolbox: toolbox6, rtl: true } );
          break;
        case 7:
