...
ListMixin: {"": "Object;",
  ...
  indexOf$2: function(receiver, element, startIndex) {
    var t1, i;
    if (typeof receiver !== "string" && (typeof receiver !== "object" || receiver === null || receiver.constructor !== Array && !H.isJsIndexable(receiver, receiver[init.dispatchPropertyName])))
      return this.indexOf$2$bailout(1, receiver, startIndex);
    t1 = receiver.length;
    if (startIndex >= t1)
      return -1;
    if (startIndex < 0)
  ...
  indexOf$2$bailout: function(state0, receiver, startIndex) {
    var i;
  ...
  lastIndexOf$2: function(receiver, element, startIndex) {
    var t1, i;
    if (typeof receiver !== "string" && (typeof receiver !== "object" || receiver === null || receiver.constructor !== Array && !H.isJsIndexable(receiver, receiver[init.dispatchPropertyName])))
      return this.lastIndexOf$2$bailout(1, receiver);
  ...
  lastIndexOf$2$bailout: function(state0, receiver) {
    var startIndex, i;
...
Location: {"": "Interceptor;host=,protocol=",
  toString$0: function(receiver) {
    return receiver.toString();
  },
  $isLocation: true,
...
["rosiep2.dart", "rosiep2.dart", , D, {
main: function() {
  var t1, t2;
  t1 = new W._EventStream(window, C.EventStreamProvider_message._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new D.main_closure()), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = $.get$block_name();
  t2.$indexSet(t2, "repeat", 0);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "black", 1);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "grey", 2);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "blue", 3);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "top", 4);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "bottom", 5);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "top_purple", 6);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "bottom_purple", 7);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "abstraction", 8);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "call", 9);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "func", 10);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "other", 11);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "then", 12);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "color", 13);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "get", 14);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "weather", 15);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "going", 16);
  t2 = $.get$block_name();
  t2.$indexSet(t2, "if", 17);
  t2 = $.get$text();
  t2.$indexSet(t2, "repeat", "Rosie wants to repeat the process, <br> choose a block to repeat over and over again<br>");
  t2 = $.get$text();
  t2.$indexSet(t2, "black", "Make sure you choose the color black <br> for one of the bottoms!");
  t2 = $.get$text();
  t2.$indexSet(t2, "grey", "Make sure you choose the color grey <br> for one of the bottoms!");
  t2 = $.get$text();
  t2.$indexSet(t2, "blue", "Make sure you choose the color blue <br> for one of the bottoms!");
  t2 = $.get$text();
  t2.$indexSet(t2, "weather", "Remember, it might be hot or cold outside");
  t2 = $.get$text();
  t2.$indexSet(t2, "top", "Make sure you choose both a top and a bottom!");
  t2 = $.get$text();
  t2.$indexSet(t2, "bottom", "Make sure you choose both a top and a bottom!");
  t2 = $.get$text();
  t2.$indexSet(t2, "top_purple", "Remember, dress code is purple! <br/> you can change the outfit color from the coloring menu<br>");
  t2 = $.get$text();
  t2.$indexSet(t2, "bottom_purple", "Remember, dress code is purple! <br> you can change the outfit color from the coloring menu<br>");
  t2 = $.get$text();
  t2.$indexSet(t2, "other", "Make sure you choose an outfit for each case");
  t2 = $.get$text();
  t2.$indexSet(t2, "then", "Make sure you choose an outfit for each case");
  t2 = $.get$text();
  t2.$indexSet(t2, "color", "Remember, top will only be either black or purple");
  t2 = $.get$text();
  t2.$indexSet(t2, "get", "Choose a block to help you decide ");
  t2 = $.get$text();
  t2.$indexSet(t2, "going", "Remember, there are two occasions");
  t2 = $.get$text();
  ...
  t2 = $.get$text();
  t2.$indexSet(t2, "all_black", "Remember, Rosie doesn't want to wear all black!");
  t2 = $.get$text();
...
compile: function(json) {
  var t1, function_begin, function_end, t2, t3, functionsLine, scriptIndex;
  J.set$length$asx($.get$outfits(), 0);
  J.set$length$asx($.get$other_outfits(), 0);
  J.set$length$asx($.get$then_outfits(), 0);
  J.set$length$asx($.get$alternate_outfits(), 0);
  D.clearBlocks();
  $.ERR_MSG = "";
  $.ERROR_BLOCK = "";
  ...
  function_begin = t1.indexOf$1(json, "{");
  function_end = t1.lastIndexOf$1(json, "}");
  if (function_end !== -1 && function_begin !== -1) {
    ...
    t3[1] = true;
    P.print("FUNC FOUND");
    functionsLine = t1.substring$2(json, function_begin, function_end + 1);
    t2 = H.stringReplaceAllUnchecked(functionsLine, "{", "");
    t2 = H.stringReplaceAllUnchecked(t2, "}", "");
    t2 = H.stringReplaceAllUnchecked(t2, "\n", "");
    $.subroutines = D.parseCode(H.stringReplaceAllUnchecked(t2, "][", "], ["));
  }
  scriptIndex = function_end + 1;
  $.commands = D.parseCode(t1.substring$1(json, scriptIndex === -1 ? 0 : scriptIndex));
  D.interpret($.commands, true);
  if (J.get$isEmpty$asx($.ERR_MSG) === true) {
    D.validate();
    if ($.check_input) {
      t1 = $.ERROR_THEN;
      if (t1.length !== 0) {
...
validate: function() {
  var i, num_level, j, t1, line;
  for ($.get$blocks(), i = 17; i >= 0; --i) {
    num_level = $.get$blocks()[i].length;
    for (j = 2; j < num_level; ++j) {
      t1 = $.get$blocks()[i];
      if (j >= t1.length)
        throw H.ioore(t1, j);
      if (J.toString$0(t1[j]) === $.CURRENT_LEVEL) {
        t1 = $.get$blocks()[i];
        if (1 >= t1.length)
          throw H.ioore(t1, 1);
        if (t1[1] !== true) {
    ...
    if (J.get$isEmpty$asx($.ERR_MSG) !== true) {
      line = J.toString$0(J.$add$ns($.ERR_MSG, " NOT FOUND"));
      H.printToConsole(line);
      $.check_input = false;
      break;
    }
...
parseCode: function(code) {
  var parsedCode, i;
  code = code.split("\n");
  for (parsedCode = null, i = 0; i < code.length; ++i)
    parsedCode = P.parse("[ " + H.S(code[i]) + " ]", null);
  return parsedCode;
},

interpret: function(commands, consider) {
  var t1, j, t2, t3, t4, t5, color, weather, place, outfit;
  if (typeof commands !== "string" && (typeof commands !== "object" || commands === null || commands.constructor !== Array && !H.isJsIndexable(commands, commands[init.dispatchPropertyName])))
    return D.interpret$bailout(1, consider, commands);
  for (t1 = J.getInterceptor(commands), j = 0; j < commands.length; ++j) {
    t2 = commands[j];
    t3 = J.getInterceptor(t2);
    if (typeof t2 === "object" && t2 !== null && (t2.constructor === Array || !!t3.$isList)) {
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
        return D.interpret$bailout(2, consider, commands, j, t1, t2);
      if (0 >= t2.length)
        throw H.ioore(t2, 0);
      t3 = t2[0];
      if (typeof t3 !== "string")
        return D.interpret$bailout(3, consider, commands, j, t1, t3);
      t3 = t3 === "GET";
    } else
      t3 = true;
    if (t3)
      ...
      H.listTypeCast(t2);
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
        return D.interpret$bailout(4, consider, commands, j, t1, t2);
      t3 = J.getInterceptor(t2);
      t4 = t2.length;
      if (0 >= t4)
        throw H.ioore(t2, 0);
      t5 = t2[0];
      if (typeof t5 !== "string")
        return D.interpret$bailout(5, consider, commands, j, t1, t2, t3, t5);
      if (t5 === "if")
        D.processIf(t2, consider);
      else if (t5 === "SET")
        ;
      else if (t5 === "repeat")
        D.processRepeat(t2, consider);
      else if (t5 === "CALL")
        D.processCall(t2, consider);
      else {
        if (1 >= t4)
          throw H.ioore(t2, 1);
        color = t2[1];
        ...
        if (typeof weather !== "string")
          return D.interpret$bailout(9, consider, commands, j, t1, t2, t3, 0, weather, color, t5);
        if (3 >= t4)
          throw H.ioore(t2, 3);
        place = t2[3];
        if (typeof place !== "string")
          return D.interpret$bailout(10, consider, commands, j, t1, 0, 0, 0, weather, color, t5, place);
        outfit = C.JSString_methods.$add(t5, color);
        if (typeof outfit !== "number")
          return D.interpret$bailout(11, consider, commands, j, t1, C.JSString_methods, 0, 0, weather, color, t5, place, outfit);
        if (C.JSString_methods.startsWith$1(t5, "top") && consider) {
          t2 = $.get$blocks();
          t3 = $.get$block_name();
          t3 = t3.$index(t3, "top");
          if (t3 >>> 0 !== t3 || t3 >= 18)
          ...
          if (1 >= t3.length)
            throw H.ioore(t3, 1);
          t3[1] = true;
          H.printToConsole("TOP block now true");
          if (J.$eq(color, "purple")) {
            t2 = $.get$blocks();
            t3 = $.get$block_name();
            t3 = t3.$index(t3, "top_purple");
            if (t3 >>> 0 !== t3 || t3 >= 18)
              throw H.ioore(t2, t3);
            t3 = t2[t3];
            if (1 >= t3.length)
        ...
        } else if (C.JSString_methods.startsWith$1(t5, "bottom") && consider) {
          t2 = $.get$blocks();
          t3 = $.get$block_name();
          t3 = t3.$index(t3, "bottom");
          if (t3 >>> 0 !== t3 || t3 >= 18)
            throw H.ioore(t2, t3);
          t3 = t2[t3];
          if (1 >= t3.length)
            throw H.ioore(t3, 1);
          t3[1] = true;
          H.printToConsole("BOTTOM block now true");
          t2 = J.getInterceptor(color);
          if (t2.$eq(color, "purple")) {
            t2 = $.get$blocks();
            t3 = $.get$block_name();
            t3 = t3.$index(t3, "bottom_purple");
            if (t3 >>> 0 !== t3 || t3 >= 18)
              throw H.ioore(t2, t3);
            t3 = t2[t3];
            if (1 >= t3.length)
            ...
            if (1 >= t3.length)
              throw H.ioore(t3, 1);
            t3[1] = true;
          } else if (t2.$eq(color, "black")) {
            t2 = $.get$blocks();
            t3 = $.get$block_name();
            t3 = t3.$index(t3, "black");
            if (t3 >>> 0 !== t3 || t3 >= 18)
              throw H.ioore(t2, t3);
            t3 = t2[t3];
            if (1 >= t3.length)
        ...
        if (t2 && weather === "cold")
          if ($.CHECK_AGAINST === "hot")
            if ($.CURRENT_BLOCK === "then") {
              $.ERROR_THEN = "weather_hot_mismatch";
              H.printToConsole("COLD OUTFIT IN HOT DAY");
              $.display_other = true;
              $.bg_hot = true;
              $.bg_cold = false;
              $.get$then_outfits().push(outfit);
            } else {
              $.ERROR_OTHER = "";
              $.get$other_outfits().push(outfit);
              $.display_other = false;
              $.bg_hot = false;
            }
            ...
            $.ERROR_OTHER = "weather_hot_mismatch";
            H.printToConsole("COLD OUTFIT IN HOT DAY");
            $.get$other_outfits().push(outfit);
            $.display_other = true;
            $.bg_hot = true;
          ...
          if ($.CHECK_AGAINST === "hot")
            if ($.CURRENT_BLOCK === "then") {
              ...
              $.ERROR_OTHER = "weather_cold_mismatch";
              H.printToConsole("HOT OUTFIT IN COLD DAY");
              $.get$other_outfits().push(outfit);
              $.display_other = true;
              $.bg_cold = true;
              $.bg_hot = false;
            ...
            $.ERROR_THEN = "weather_cold_mismatch";
            H.printToConsole("HOT OUTFIT IN COLD DAY");
            $.get$then_outfits().push(outfit);
            $.display_other = true;
            $.bg_cold = true;
        ...
        if (consider)
          $.get$outfits().push(outfit);
      }
    }
  }
},

interpret$bailout: function(state0, consider, commands, j, t1, t2, t3, t4, weather, color, part, place, outfit) {
  switch (state0) {
    case 0:
    case 1:
      state0 = 0;
      t1 = J.getInterceptor$asx(commands);
      j = 0;
    default:
      L0:
        while (true)
          switch (state0) {
            case 0:
              t2 = t1.get$length(commands);
              if (typeof t2 !== "number")
                throw H.iae(t2);
              if (!(j < t2))
                break L0;
              t2 = t1.$index(commands, j);
              t3 = J.getInterceptor(t2);
            default:
              if (state0 === 3 || state0 === 2 || state0 === 0 && typeof t2 === "object" && t2 !== null && (t2.constructor === Array || !!t3.$isList))
                switch (state0) {
                  case 0:
                    t2 = t1.$index(commands, j);
                  case 2:
                                      ...
                                      if (state0 === 0 && J.$eq(t4, "CALL"))
                                        ...
                                        switch (state0) {
                                          case 0:
                                            part = t3.$index(t2, 0);
                                            color = t3.$index(t2, 1);
                                            weather = t3.$index(t2, 2);
                                          case 9:
                                            state0 = 0;
                                            place = t3.$index(t2, 3);
                                          case 10:
                                            state0 = 0;
                                            t2 = J.getInterceptor$ns(part);
                                            outfit = t2.$add(part, color);
                                          case 11:
                                            state0 = 0;
                                            if (t2.startsWith$1(part, "top") && consider) {
                                              t2 = $.get$blocks();
                                              t3 = $.get$block_name();
                                              t3 = t3.$index(t3, "top");
                                              if (t3 >>> 0 !== t3 || t3 >= 18)
                                            ...
                                            } else if (t2.startsWith$1(part, "bottom") && consider) {
                                              t2 = $.get$blocks();
                                              t3 = $.get$block_name();
                                              t3 = t3.$index(t3, "bottom");
                                              if (t3 >>> 0 !== t3 || t3 >= 18)
                                            ...
                                            if ($.CURRENT_LEVEL === "3" && J.$eq(weather, "cold"))
                                              if ($.CHECK_AGAINST === "hot")
                                                if ($.CURRENT_BLOCK === "then") {
                                                  $.ERROR_THEN = "weather_hot_mismatch";
                                                  H.printToConsole("COLD OUTFIT IN HOT DAY");
                                            ...
                                            else if ($.CURRENT_LEVEL === "3" && J.$eq(weather, "hot"))
                                              if ($.CHECK_AGAINST === "hot")
                                                if ($.CURRENT_BLOCK === "then") {
                                                  $.ERROR_THEN = "";
                                                  $.get$then_outfits().push(outfit);
                                            ...
                                            if ($.CURRENT_LEVEL === "5" && J.$eq(place, "wedding"))
                                              if ($.CHECK_AGAINST === "wedding")
                                                if ($.CURRENT_BLOCK === "then") {
                                                  $.ERROR_THEN = "";
                                                  $.get$then_outfits().push(outfit);
                                            ...
                                            if ($.CURRENT_LEVEL === "5" && J.$eq(place, "gym"))
                                              if ($.CHECK_AGAINST === "wedding")
                                                if ($.CURRENT_BLOCK === "then") {
                                                  $.ERROR_THEN = "place_wedding_mismatch";
                                                  $.get$then_outfits().push(outfit);
...
processCall: function(nested, consider) {
  var funcName, t1, t2, block, i, t3;
  if (typeof nested !== "string" && (typeof nested !== "object" || nested === null || nested.constructor !== Array && !H.isJsIndexable(nested, nested[init.dispatchPropertyName])))
    return D.processCall$bailout(1, consider, nested);
  if (1 >= nested.length)
    throw H.ioore(nested, 1);
  funcName = nested[1];
  t1 = $.get$blocks();
  ...
  t1 = J.getInterceptor(funcName);
  block = null;
  i = 0;
  while (true) {
    t2 = J.get$length$asx($.subroutines);
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (!(i < t2))
      break;
    t2 = $.subroutines;
    if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
      return D.processCall$bailout(2, consider, 0, i, block, t1, funcName, t2);
    if (i >= t2.length)
      throw H.ioore(t2, i);
    t2 = t2[i];
    if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
      return D.processCall$bailout(3, consider, 0, i, block, t1, funcName, t2);
    if (0 >= t2.length)
      throw H.ioore(t2, 0);
    if (t1.$eq(funcName, t2[0])) {
      t2 = $.subroutines;
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
        return D.processCall$bailout(4, consider, 0, i, 0, t1, funcName, t2);
      if (i >= t2.length)
        throw H.ioore(t2, i);
      t2 = t2[i];
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
        return D.processCall$bailout(5, consider, 0, i, 0, t1, funcName, t2);
      if (1 >= t2.length)
        throw H.ioore(t2, 1);
      block = t2[1];
      t2 = J.get$length$asx(block);
      if (typeof t2 !== "number")
        throw t2.$ge();
      if (t2 >= 1) {
        t2 = $.get$blocks();
        t3 = $.get$block_name();
        t3 = t3.$index(t3, "abstraction");
        if (t3 >>> 0 !== t3 || t3 >= 18)
          throw H.ioore(t2, t3);
        t3 = t2[t3];
        if (1 >= t3.length)
...
processCall$bailout: function(state0, consider, nested, i, block, t1, funcName, t2) {
  switch (state0) {
    case 0:
    case 1:
      state0 = 0;
      funcName = J.$index$asx(nested, 1);
      t1 = $.get$blocks();
      t2 = $.get$block_name();
      t2 = t2.$index(t2, "call");
      if (t2 >>> 0 !== t2 || t2 >= 18)
        ...
        while (true)
          switch (state0) {
            ...
            case 3:
              state0 = 0;
            default:
              if (state0 === 5 || state0 === 4 || state0 === 0 && t1.$eq(funcName, J.$index$asx(t2, 0)))
                switch (state0) {
                  case 0:
                    t2 = $.subroutines;
                  case 4:
...
processIf: function(nested, consider) {
  var t1, t2, t3, condition, then, other;
  if (typeof nested !== "string" && (typeof nested !== "object" || nested === null || nested.constructor !== Array && !H.isJsIndexable(nested, nested[init.dispatchPropertyName])))
    return D.processIf$bailout(1, nested);
  ...
  if (typeof t3 !== "string" && (typeof t3 !== "object" || t3 === null || t3.constructor !== Array && !H.isJsIndexable(t3, t3[init.dispatchPropertyName])))
    return D.processIf$bailout(2, nested, t1, t3);
  if (0 >= t3.length)
    throw H.ioore(t3, 0);
  condition = t3[0];
  if (2 >= t2)
  ...
  if (t2 >= 1) {
    ...
    if (1 >= t3.length)
      throw H.ioore(t3, 1);
    t3[1] = true;
    H.printToConsole("THEN POPULATED");
  }
  ...
  if (t2 >= 1) {
    ...
    if (1 >= t3.length)
      throw H.ioore(t3, 1);
    t3[1] = true;
    H.printToConsole("OTHER POPULATED");
  }
  t2 = J.getInterceptor(condition);
  if (!t2.$eq(condition, 0)) {
    if (t2.$eq(condition, "Going")) {
      t2 = $.get$blocks();
      t3 = $.get$block_name();
      t3 = t3.$index(t3, "going");
      if (t3 >>> 0 !== t3 || t3 >= 18)
        throw H.ioore(t2, t3);
      t3 = t2[t3];
      if (1 >= t3.length)
      ...
      t2 = nested[1];
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
        return D.processIf$bailout(3, nested, t1, t2, other, then);
      if (1 >= t2.length)
        throw H.ioore(t2, 1);
      t2 = t2[1];
      if (typeof t2 !== "string")
        return D.processIf$bailout(4, nested, t1, t2, other, then);
      $.CHECK_AGAINST = t2 === "wedding" ? "wedding" : "gym";
      if (t2 === $.CURRENT_PLACE) {
        $.CURRENT_BLOCK = "then";
        D.interpret(then, true);
        $.CURRENT_BLOCK = "other";
        D.interpret(other, false);
      } else {
        $.CURRENT_BLOCK = "other";
        D.interpret(other, true);
        $.CURRENT_BLOCK = "then";
        D.interpret(then, false);
      }
    } else if (t2.$eq(condition, "weather")) {
      t2 = $.get$blocks();
      t3 = $.get$block_name();
      t3 = t3.$index(t3, "weather");
      if (t3 >>> 0 !== t3 || t3 >= 18)
        throw H.ioore(t2, t3);
      t3 = t2[t3];
      if (1 >= t3.length)
      ...
      t2 = nested[1];
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !H.isJsIndexable(t2, t2[init.dispatchPropertyName])))
        return D.processIf$bailout(6, nested, t1, t2, other, then);
      if (1 >= t2.length)
        throw H.ioore(t2, 1);
      t2 = t2[1];
      if (typeof t2 !== "string")
        return D.processIf$bailout(7, nested, t1, t2, other, then);
      $.CHECK_AGAINST = t2 === "hot" ? "hot" : "cold";
      if (t2 === $.CURRENT_WEATHER) {
        $.CURRENT_BLOCK = "then";
        D.interpret(then, true);
        $.CURRENT_BLOCK = "other";
        D.interpret(other, false);
...
processIf$bailout: function(state0, nested, t1, t2, other, then) {
  switch (state0) {
    case 0:
    case 1:
      state0 = 0;
      t1 = J.getInterceptor$asx(nested);
      t2 = t1.$index(nested, 1);
    case 2:
      state0 = 0;
      condition = J.$index$asx(t2, 0);
      then = t1.$index(nested, 2);
      other = t1.$index(nested, 3);
      t2 = $.get$blocks();
      t3 = $.get$block_name();
      t3 = t3.$index(t3, "if");
      if (t3 >>> 0 !== t3 || t3 >= 18)
    ...
    default:
      var condition, t3;
      if (state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 0 && !t2.$eq(condition, 0))
        switch (state0) {
          case 0:
          default:
            if (state0 === 5 || state0 === 4 || state0 === 3 || state0 === 0 && t2.$eq(condition, "Going"))
              switch (state0) {
                case 0:
                  t2 = $.get$blocks();
                  t3 = $.get$block_name();
                ...
                case 4:
                  state0 = 0;
                  $.CHECK_AGAINST = J.$eq(t2, "wedding") ? "wedding" : "gym";
                  t1 = t1.$index(nested, 1);
                case 5:
                  state0 = 0;
                  if (J.$eq(J.$index$asx(t1, 1), $.CURRENT_PLACE)) {
                    $.CURRENT_BLOCK = "then";
                    D.interpret(then, true);
                    $.CURRENT_BLOCK = "other";
                    D.interpret(other, false);
              ...
              switch (state0) {
                case 0:
                default:
                  if (state0 === 8 || state0 === 7 || state0 === 6 || state0 === 0 && t2.$eq(condition, "weather"))
                    switch (state0) {
                      case 0:
                        t2 = $.get$blocks();
                        t3 = $.get$block_name();
                      ...
                      case 7:
                        state0 = 0;
                        $.CHECK_AGAINST = J.$eq(t2, "hot") ? "hot" : "cold";
                        t1 = t1.$index(nested, 1);
                      case 8:
                        state0 = 0;
                        if (J.$eq(J.$index$asx(t1, 1), $.CURRENT_WEATHER)) {
                          $.CURRENT_BLOCK = "then";
                          D.interpret(then, true);
                          $.CURRENT_BLOCK = "other";
                          D.interpret(other, false);
...
randomize: function() {
  var places, x, t1, colors, weather;
  places = ["wedding", "gym"];
  x = C.C__Random.nextInt$1(2);
  if (x < 0 || x >= 2)
    throw H.ioore(places, x);
  $.CURRENT_PLACE = places[x];
  t1 = $.get$text();
  t1.$indexSet(t1, "place_gym_mismatch", "Don't be silly! <br> choose appropriate outfits to each place!");
  t1 = $.get$text();
  t1.$indexSet(t1, "place_wedding_mismatch", "Don't be silly! <br> choose appropriate outfits to each place!");
  colors = ["black", "purple"];
  x = C.C__Random.nextInt$1(2);
  if (x < 0 || x >= 2)
    throw H.ioore(colors, x);
  $.CURRENT_COLOR = colors[x];
  weather = ["hot", "cold"];
  x = C.C__Random.nextInt$1(2);
  if (x < 0 || x >= 2)
    throw H.ioore(weather, x);
  $.CURRENT_WEATHER = weather[x];
  t1 = $.get$text();
  t1.$indexSet(t1, "weather_hot_mismatch", "Don't be silly! <br> choose appropriate outfits to each weather!");
  t1 = $.get$text();
  t1.$indexSet(t1, "weather_cold_mismatch", "Don't be silly! <br> choose appropriate outfits to each weather!");
},
...
display: function(x) {
  ...
  if (x === 1) {
    ...
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    D.sendMessage(C.JSString_methods.$add("outfit ", t1[0]));
    J.removeAt$1$ax($.get$outfits(), 0);
  } else {
    t1 = $.get$alternate_outfits();
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    D.sendMessage(C.JSString_methods.$add("outfit ", t1[0]));
    J.removeAt$1$ax($.get$alternate_outfits(), 0);
  }
},
...
sendMessage: function(message) {
  var msg, origin;
  msg = "@blockly#" + message;
  origin = J.$add$ns(J.$add$ns(J.get$protocol$x(C.Window_methods.get$location(window)), "//"), J.get$host$x(C.Window_methods.get$location(window)));
  C.Window_methods.postMessage$2(window, msg, origin);
},

main_closure: {"": "Closure;",
  call$1: function(evt) {
    var msg, t1;
    msg = H.S(J.get$data$x(evt));
    if (C.JSString_methods.startsWith$1(msg, "@dart")) {
      ...
      if (1 >= t1.length)
        throw H.ioore(t1, 1);
      D.compile(t1[1]);
      P.print("Dart received code from HTML ");
      if ($.get$outfits().length !== 0)
        P.Timer_Timer(C.Duration_0, new D.main__closure());
      $.timer = P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 1000, 0, 0), new D.main__closure0());
      D.sendMessage("GOT IT!");
    }
  }
},
  ...
  call$1: function(t) {
    ...
    if ($.get$outfits().length === 0) {
      ...
      if ($.check_input)
        ...
        t1 = $.get$text();
        D.sendMessage(C.JSString_methods.$add("error ", t1.$index(t1, $.ERR_MSG)));
      }
    } else
      D.display(1);
  }
...
Isolate.$lazy($, "outfits", "outfits", "get$outfits", function() {
  return P.List_List(null, null);
});
Isolate.$lazy($, "other_outfits", "other_outfits", "get$other_outfits", function() {
  return P.List_List(null, null);
});
Isolate.$lazy($, "then_outfits", "then_outfits", "get$then_outfits", function() {
  return P.List_List(null, null);
});
Isolate.$lazy($, "alternate_outfits", "alternate_outfits", "get$alternate_outfits", function() {
  return P.List_List(null, null);
});
Isolate.$lazy($, "blocks", "blocks", "get$blocks", function() {
  return [["repeat", false, 6], ["black", false, 6], ["grey", false, 6], ["blue", false, 6], ["top", false, 1, 2, 3, 4, 5], ["bottom", false, 1, 2, 3, 4, 5, 6], ["top_purple", false, 2], ["bottom_purple", false, 2], ["abstraction", false, 4, 5], ["call", false, 4, 5], ["func", false, 4, 5], ["other", false, 3, 5], ["then", false, 3, 5], ["color", false], ["get", false], ["weather", false, 3], ["going", false, 0], ["if", false, 3, 5]];
});
Isolate.$lazy($, "block_name", "block_name", "get$block_name", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSInt);
});
Isolate.$lazy($, "text", "text", "get$text", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSString);
});
// Native classes
J.Interceptor["%"] = "DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError";
...
//# sourceMappingURL=rosiep2.dart.js.map
//@ sourceMappingURL=rosiep2.dart.js.map
